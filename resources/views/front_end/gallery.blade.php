			...
			<div class="row">
				<div class="col-lg-3 col-md-4 col-sm-6">
					<a class="gallery__item fresco" href="img/gallery/1.jpg" data-fresco-group="gallery">
						<img src="{{ asset('frontend/img/gallery/1.jpg')}}" alt="">
					</a>
				</div>
				<div class="col-lg-3 col-md-4 col-sm-6">
				...
				<div class="col-lg-3 col-md-4 col-sm-6">
					<a class="gallery__item fresco" href="img/gallery/9.jpg" data-fresco-group="gallery">
						<img src="{{ asset('frontend/img/gallery/9.jpg') }}" alt="">
					</a>
				</div>
				<div class="col-lg-3 col-md-4 col-sm-6">
					<a class="gallery__item fresco" href="img/gallery/10.jpg" data-fresco-group="gallery">
						<img src="{{ asset('frontend/img/gallery/10.jpg') }}" alt="">
					</a>
				</div>
				<div class="col-lg-3 col-md-4 col-sm-6">
					<a class="gallery__item fresco" href="img/gallery/11.png" data-fresco-group="gallery">
						<img src="{{ asset('frontend/img/gallery/11.png') }}" alt="">
					</a>
				</div>
				<div class="col-lg-3 col-md-4 col-sm-6">
					<a class="gallery__item fresco" href="img/gallery/line.png" data-fresco-group="gallery">
						<img src="{{ asset('frontend/img/gallery/line.png') }}" alt="">
					</a>
				</div>
			</div>
		</div>
